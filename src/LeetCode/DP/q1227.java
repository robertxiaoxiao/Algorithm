...
If the 1st passenger get the 2nd seat, with probability 1/n,
then n-1 seats left. Here, the 2nd passenger faces the same situation of the 1st passenger
, he can just randomly choose a seat. So it is the same question
but n becomes n-1. In this situation, the probability that the n-th passenger
 gets his seat is f(n-1). So the final probability is f(n-1)*(1/n)
